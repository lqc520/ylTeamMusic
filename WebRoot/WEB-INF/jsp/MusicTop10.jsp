...
<head>
<meta charset="utf-8" />
<title>Guide Music | Hot song TOP10 </title>
				...
				<div class="form-group">
					<div class="input-group">
						<span class="input-group-btn">
							...
							placeholder="请输入歌名或者歌手" style="width:600px;" name="content">
					</div>
				</div>
			</form>
										...
										<section class="scrollable">
											...
											<div class="m-t-n-xxs item pos-rlt">
												...
												<div class="bottom gd bg-info wrapper-lg">
													<span class="pull-right text-sm">10 <br>Followers
													</span> <span class="h2 font-thin">Guide music</span>
												</div>
												<img class="img text-center" src="images/m43.jpg" alt="..." style="width: 100%">
											</div>
											<ul
